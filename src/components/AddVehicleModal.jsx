...
const AddVehicleModal = ({ isOpen, onClose }) => {
  ...
  const handleSaveProduct = () => {
    ...
    console.log('Saved Vehicle:', formData)
          ...
          <div className="mx-[156px]">
            <label className="flex w-[207px] m-auto items-center justify-center border-2 border-dashed border-gray-300 rounded-md h-32 mb-[30px] cursor-pointer">
              {formData.imagePreview ? (
                ...
                <div className="form-subheading text-center">
                  ...
                  <p>Upload Vehicle Registeration document</p>
                </div>
              )}
              <input
                type="file"
            ...
            <form className="space-y-4" onSubmit={handleContinue}>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center">
                    <select
                      ...
                      className="w-full input-border p-[15px] text-sm border rounded focus:outline-none text-blueBrand-normal"
                    >
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  <label className="block form-label mb-[5px] text-blueBrand-lighter">
                    Vehicle Capacity (Weight Limit in tons/kg)
                  </label>
                  <div className="flex items-center input-border p-[15px] text-sm">
                    <input
                      type="number"
            ...
            <div className="flex justify-end mt-[50px] gap-[30px]">
              <button
                type="button"
                onClick={onClose}
        ...
        {step === 2 && (
          <div className="mx-[156px]">
            ...
            <div className="flex justify-between items-center mb-4">
              <h4 className="text-sm font-bold">Vehicle Details</h4>
              <button
                onClick={handleEdit}
            ...
            <div className="text-sm space-y-[15px] mb-[30px]">
              <div className="flex justify-between">
                <span className="product-header">Vehicle Name</span>
